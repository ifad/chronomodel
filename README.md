...
Overlapping history record are prevented using [exclusion constraints](http://www.postgresql.org/docs/9.3/static/sql-createtable.html#SQL-CREATETABLE-EXCLUDE)
